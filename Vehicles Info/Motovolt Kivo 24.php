...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Motovolt Kivo 24/download (3).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (7).jpg" alt="Nexzu Bazinga">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download.jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (5).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (2).jpg" alt="Motovolt Kivo 24 with carrier">
                    <div class="content">
                        <h3>With carrier</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (5).jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Kivo 24 Basic- Normal Range</td>
                    <td>₹ 29,774</td>
                ...
                <tr>
                    <td>Kivo 24 Standard- Normal Range</td>
                    <td>₹ 30,574</td>
                ...
                <tr>
                    <td>Kivo 24 Smart- Normal Range</td>
                    <td>₹ 32,825</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The price of Motovolt Kivo 24 in India starts at Rs. 29,774 and goes upto Rs. 42,159. Motovolt Kivo 24 comes with 16 variants which includes Kivo Basic - Normal Range, Kivo Standard - Normal Range. The top variant is Kivo Smart Plus - Long Range Fast Charge which comes at a price tag of Rs. 42,159.
            <span id="dots">...</span><span id="more">
        
         <br><br><strong>Exterior</strong><br>
        
         The Motovolt Kivo 24 is built solidly, yet it feels light due to the use of steel in its frame—keeping the bike solid and lightweight at the same time makes it easy to zip through even against a strong breeze.
         <br><br><strong>Conclusion</strong><br>

         The stylish design, high-quality components, and robust build on the Motovolt Kivo 24 electric bike will provide you with an amazing experience in your commute. Features such as these, make the Motovolt Kivo 24 electric bike ideal for use on smooth as well as rough terrain. Hence, pick up the Motovolt Kivo 24 electric bike today, contribute towards leaving ensuring a sustainable future, and have an amazing commuting experience.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download.jpg" alt="White">
                    <div class="content">
                        <h3>White</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (7).jpg" alt="Pink">
                    <div class="content">
                        <h3>Pink</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (3).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>                
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo 24/download (4).jpg" alt="Orange">
                    <div class="content">
                        <h3>Orange</h3>
                    </div>
                </div>                 -->
...
<br> <strong>For More Information : </strong> <a href="https://www.motovolt.co/kivo-24" target="_blank" >Click Here </a>

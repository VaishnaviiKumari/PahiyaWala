...
<head>
    ...
    <title>Motovolt Kivo Easy    </title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Motovolt Kivo Easy/logo recent img.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo Easy/download (1).jpg" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo Easy/download (2).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Kivo Easy/download (4).jpg" alt="">
                    <div class="content">
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- Rs29774-Rs42159 &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong>  Range</strong> :-  30 - 105 km/charge&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong>Battery Type  </strong> :- Lithium Ion&nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        ...
        <i class="fa-solid fa-car-side"></i> <strong> Kerb Weight</strong> :- 23kg &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-bolt"></i> <strong>Fast Charging</strong> :- Yes
     </div>
    </section>
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Motovolt Kivo Easy Standard - Normal Range
                    </td>
                    <td>₹  30,574</td>
                    <td> This Basic - Normal Range variant comes with an engine putting out and of max power and max torque respectively. Motovolt Kivo Easy Basic - Normal Range is available in 3 colours : Purple, Pink and Equa.</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Kivo Easy Smart - Normal Range</td>
                    <td>₹ 32,825</td>
                    <td>Push Button Start, 
                        Single,4” Multi-Functional
                    </td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Kivo Easy Basic - Long Range</td>
                    <td>₹ 36,678</td>
                    <td>Sunroof, Cruise Control, Push Button Start, Wireless Charger, Ventilated Seats</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Motovolt Kivo Easy Smart - Long Range</td>
                    <td>₹ 39,729</td>
